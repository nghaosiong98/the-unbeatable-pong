...
import pacman.controllers.examples.evaluators.*;
...
public class MyMonteCarloPacMan extends PacmanController {

//    public static void main(String[] args) {
//        Executor po = new Executor(true, true, true);
//        po.setDaemon(true);
//        po.runGame(new MyMonteCarloPacMan(), new POCommGhosts(), true, 40);
//    }
