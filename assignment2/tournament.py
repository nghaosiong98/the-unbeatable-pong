...
from game_agent import aggressive_heuristic, defensive_heuristic, maximizing_win_chances_heuristic, minimizing_losing_chances_heuristic, chances_heuristic, weighted_chances_heuristic, weighted_chances_heuristic_2, my_custom_heuristic_haosiong, custom_heuristic_junshou, custom_heuristic_robinson, my_custom_heuristic_marina
...
def main():
    ...
    MY_ARGS = {"method": 'minimax', "iterative": True}
    ...
    test_agents = [
        Agent(CustomPlayer(score_fn=my_custom_heuristic_haosiong, **MY_ARGS), "HaoSiong"),
        Agent(CustomPlayer(score_fn=custom_heuristic_junshou, **MY_ARGS), "JunShou"),
        Agent(CustomPlayer(score_fn=custom_heuristic_robinson, **MY_ARGS), "Robinson"),
        Agent(CustomPlayer(score_fn=my_custom_heuristic_marina, **MY_ARGS), "Marina"),
    ]
