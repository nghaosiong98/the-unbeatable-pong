...
from game_agent import custom_heuristic_robinson,custom_heuristic_junshou,my_custom_heuristic_marina,my_custom_heuristic_haosiong,aggressive_heuristic, defensive_heuristic, maximizing_win_chances_heuristic, minimizing_losing_chances_heuristic, chances_heuristic, weighted_chances_heuristic, weighted_chances_heuristic_2
...
def main():
    ...
    #               Agent(CustomPlayer(score_fn=custom_heuristic, **CUSTOM_ARGS), "Student1")]
    #custom_heuristic_robinson,custom_heuristic_junshou,my_custom_heuristic_marina,my_custom_heuristic_haosiong
    test_agents = [Agent(CustomPlayer(score_fn=improved_score, **CUSTOM_ARGS), "ID_Improved"),
                   Agent(CustomPlayer(score_fn=custom_heuristic_robinson, **CUSTOM_ARGS), "Student Robinson"),
                   Agent(CustomPlayer(score_fn=custom_heuristic_junshou, **CUSTOM_ARGS), "Student Jun Shou"),
                   Agent(CustomPlayer(score_fn=my_custom_heuristic_marina, **CUSTOM_ARGS), "Student Hao Siong"),
                   Agent(CustomPlayer(score_fn=my_custom_heuristic_haosiong, **CUSTOM_ARGS), "Student Marina")]
